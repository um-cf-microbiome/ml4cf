...
##### Path Setting #####
libsvm = "/mnt/d/software/libsvm-3.22"
gridpy_exe = '%s/tools/grid.py -log2c -2,9,2 -log2g 1,-11,-2' % (libsvm)
svmtrain_exe='%s/svm-train' % (libsvm)
svmpredict_exe='%s/svm-predict' % (libsvm)
...
def main():
	...
	fnum_v = [15,14,13,12,11,10,9,8,7,6,5] #feat_num_try(f_tuples) #ex: [50,25,12,6,3,1]
