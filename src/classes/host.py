...
class info(user_name,host_name):
     def __init__(self):
...
# Setup computing environment for user 'meek'
      if 'meek' in self.user_name:
       if socket.gethostname() == 'WSPDR062':
        ...
        self.mothur_path = str(host_base+"software/mothur/mothur.exe")
       ...
       if socket.gethostname() == 'Louie':
        ...
        self.mothur_path = str(host_base+"software/mothur_win/mothur/mothur.exe")
       ...
       if socket.gethostname() == 'elbel':
        ...
        self.mothur_path = str(host_base+"software/mothur/")
