...
# write_list.extend([str('screen.seqs(fasta='+mothur_output_path+'stability.trim.contigs.fasta, group='+mothur_output_path+'stability.contigs.groups, maxambig=0, maxlength=275)\n')])
...
# write_list.extend([str('classify.seqs(fasta=current, count=current, reference='+mothur_ref_dir+'trainset9_032012.pds.fasta, taxonomy='+mothur_ref_dir+'trainset9_032012.pds.tax, cutoff=80)\n')])
 write_list.extend([str('cluster.split(fasta='+mothur_output_path+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.fasta, count='+mothur_output_path+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.pick.count_table, taxonomy='+mothur_output_path+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.pds.wang.taxonomy, splitmethod=classify, taxlevel=4, cutoff=0.15,processors=4)\n')])
 write_list.extend([str('make.shared(list='+mothur_output_path+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.accnos, count=current, label=0.03)\n')])
