...
def mothur_command_list(level_list,mothur_ref_dir,processors,control_list):
 ...
 input_command_list.extend([str('make.contigs(file='+mothur_ref_dir+'stability.files, processors='+str(processors)+')\n')])
 ...
 input_command_list.extend([str('screen.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.fasta, group='+mothur_ref_dir+'stability.contigs.groups, maxambig=0, maxlength=275)\n')])
 ...
 input_command_list.extend([str('align.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.align, reference='+mothur_ref_dir+'silva.v4.fasta,processors='+str(processors)+')\n')])
 ...
 input_command_list.extend([str('screen.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.count_table, start=1968, end=11550, maxhomop=8)\n')])
 output_file_list.append(["stability.filter","stability.trim.contigs.good.unique.good.filter.fasta"],ignore_index=True)
 input_command_list.extend([str('filter.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.align, vertical=T, trump=.)\n')])
 ...
 input_command_list.extend([str('unique.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.good.filter.count_table)\n')])
 ...
 input_command_list.extend([str('pre.cluster(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.count_table, diffs=2)\n')])
 ...
 input_command_list.extend([str('chimera.uchime(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.count_table, dereplicate=t)\n')])
 ...
 input_command_list.extend([str('classify.seqs(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.count_table, reference='+mothur_ref_dir+'trainset9_032012.pds.fasta, taxonomy='+mothur_ref_dir+'trainset9_032012.pds.tax, cutoff=80)\n')])
 ...
 input_command_list.extend([str('remove.lineage(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.count_table, taxonomy='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.taxonomy, taxon=Chloroplast-Mitochondria-unknown-Archaea-Eukaryota)\n')])
 ...
 input_command_list.extend([str('remove.groups(count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.count_table, fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.fasta, taxonomy='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.taxonomy, groups='+format_control_list(control_list)+')\n')])
 ...
 input_command_list.extend([str('cluster.split(fasta='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.fasta, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.pick.count_table, taxonomy='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.pick.taxonomy, splitmethod=classify, taxlevel=4, cutoff=0.15,processors=4)\n')])
 ...
 input_command_list.extend([str('make.shared(list='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.list, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.pick.count_table, label=0.03)\n')])
 ...
 input_command_list.extend([str('classify.otu(list='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.list, count='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.pick.count_table, taxonomy='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.pick.taxonomy, label=0.03)\n')])
 ...
 input_command_list.extend([str('phylotype(taxonomy='+mothur_ref_dir+'stability.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.pick.taxonomy)\n')])
...
def make_batch(stability_files_name,batch_file,mothur_ref_dir,control_list,mothur_output_path,processors):
 ...
 input_command_list,output_file_list = mothur_command_list(level_list,mothur_ref_dir,processors,control_list)
